...
class KoyukiCard(QWidget):
    def __init__(self, title, widget: QWidget, sourcePath, stretch=0, parent=None):
        ...
        self.sourcePathLabel = BodyLabel(
            self.tr('网页链接跳转'), self.sourceWidget)
...
class KoyukiCardWithoutSource(QWidget):
...
class KoyukiInterface(ScrollArea):
    ...
    def addKoyukiCard(self, title, widget, sourcePath: str, stretch=0):
        card = KoyukiCard(title, widget, sourcePath, stretch, self.view)
        self.vBoxLayout.addWidget(card, 0, Qt.AlignTop)
        return card
    
    def addKoyukiCardWithoutSource(self, title, widget, stretch=0):
        card = KoyukiCardWithoutSource(title, widget, stretch, self.view)
        self.vBoxLayout.addWidget(card, 0, Qt.AlignTop)
        return card
